    ...
    class Meta:
        ...
        widgets = {
            ...
            "first_name": forms.TextInput(
                attrs={"class": "w-full px-4 py-3 border border-gray-300 rounded-xl"}
            ),
            ...
            "payment_method": forms.RadioSelect(
                attrs={"class": "focus:ring-green-500"}
            ),
        }
...
class AddToCartForm(forms.Form):
    quantity = forms.IntegerField(
        ...
        widget=forms.NumberInput(
            attrs={"class": "w-16 text-center border border-gray-300 rounded-xl"}
        ),
    )
